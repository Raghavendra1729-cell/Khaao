...
func (m *mockOrderRepo) Create(ctx context.Context, o *models.Order) error { o.ID = uint(len(m.orders)+1); m.orders[o.ID] = o; return nil }
func (m *mockOrderRepo) Save(ctx context.Context, o *models.Order) error { m.orders[o.ID] = o; return nil }
func (m *mockOrderRepo) SaveItem(ctx context.Context, i *models.OrderItem) error { return nil }
func (m *mockOrderRepo) FindByID(ctx context.Context, id uint) (*models.Order, error) { return m.orders[id], nil }
func (m *mockOrderRepo) FindActiveByUserID(ctx context.Context, uid uint) (*models.Order, error) { return nil, nil }
func (m *mockOrderRepo) FindHistoryByUserID(ctx context.Context, uid uint) ([]models.Order, error) { return nil, nil }
...
func (m *mockOrderRepo) FindAwaitingPayment(ctx context.Context) ([]models.Order, error) { return nil, nil }
func (m *mockOrderRepo) FindTerminalByDate(ctx context.Context, date string) ([]models.Order, error) { return nil, nil }
...
func (m *mockOrderRepo) FindReadyExpired(ctx context.Context) ([]models.Order, error) { return nil, nil }
func (m *mockOrderRepo) FindNonTerminal(ctx context.Context) ([]models.Order, error) { return nil, nil }

type mockMenuRepo struct {}
func (m *mockMenuRepo) FindAll(ctx context.Context, avail bool) ([]models.MenuItem, error) { return nil, nil }
...
func (m *mockMenuRepo) FindMapByIDs(ctx context.Context, ids []uint) (map[uint]models.MenuItem, error) { return nil, nil }
...
func (m *mockPoolRepo) Add(ctx context.Context, itemID uint, qty int) error { m.pool[itemID] += qty; return nil }
